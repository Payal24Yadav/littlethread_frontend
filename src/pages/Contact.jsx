        ...
        >
          <form className="space-y-6 md:space-y-8">
            ...
            <div className="space-y-2">
              ...
              <select className="w-full bg-neutral-50 text-neutral-900 border border-neutral-200 px-5 py-4 rounded-2xl focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-colors appearance-none">
            ...
            <button className="w-full py-4 sm:py-5 bg-primary text-white font-black text-base sm:text-xl rounded-2xl hover:scale-[1.02] active:scale-95 transition-all shadow-xl shadow-primary/20">
              SEND MESSAGE
            </button>
          </form>
        </motion.div>
