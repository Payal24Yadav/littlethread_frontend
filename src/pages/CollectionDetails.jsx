      ...
      <section className="container mx-auto px-4 py-10 sm:px-6 lg:px-8">
        ...
        {products.length === 0 ? (
          <div className="mx-auto max-w-xl rounded-2xl border border-neutral-200 bg-white px-6 py-12 text-center shadow-sm">
            <h3 className="text-xl font-black text-neutral-900">No products in this collection yet</h3>
            <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-neutral-500">Stay tuned. New arrivals will appear here as soon as they are added.</p>
            <Link to="/shop" className="mt-6 inline-flex h-11 items-center rounded-full bg-primary px-6 text-xs font-black uppercase tracking-widest text-white transition hover:bg-neutral-950">
